...
│      Server          │
├──────────────────────┤
│  Tool Registry       │  79 tools, auto-discovered
...
1. **Built-in defaults** — Safe defaults for all 79 tools
...
- **Progressive disclosure** — Tier 1 (16 tools) visible in `tools/list`; Tier 2 (63 tools) discoverable via `search-tools`
