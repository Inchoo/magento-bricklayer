...
Bricklayer uses progressive disclosure. Only 17 essential tools are listed in `tools/list`. Use `search-tools` to discover the full set of 84 tools by keyword.
